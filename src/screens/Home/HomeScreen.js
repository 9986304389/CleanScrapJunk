...
import { Text, View, TouchableWithoutFeedback, Keyboard, ScrollView, RefreshControl, TouchableOpacity, BackHandler, Alert } from "react-native";
...
export default function HomeScreen(props) {
  ...
  // Extract the name of the current screen from the route
  ...
  }, [navigation, userName, userLocation]);
